...
create_table_as_stmt =
    ...
    ife:KW_IF_NOT_EXISTS? __
    t:table_name __
	ta:(table_attribute __)*
    as:'AS'i __ select_stmt {
...
create_table_stmt
  = a:KW_CREATE __
	...
	bkp:(KW_BACKUP __ ("YES"i/"NO"i) __)?
    to:table_options? __
	ta:(table_attribute __)*
...
column_attribute
  = ('GENERATED BY DEFAULT AS'i)* __ ('IDENTITY'i) __ (LPAREN __ [0-9] __ COMMA __ [0-9] __ RPAREN)*
  / ('ENCODE'i) __ ('AZ64'i / 'BYTEDICT'i / 'DELTA' / 'DELTA32K'i / 'LZO'i / 'MOSTLY8'i / 'MOSTLY16'i  /'MOSTLY32'i / 'RAW'i / 'RUNLENGTH'i / 'TEXT255'i / 'TEXT32K'i / 'ZSTD'i )
  / ('DISTKEY'i)
  / ('SORTKEY'i)
  / ('COLLATE'i) ('CASE_SENSITIVE'i / 'CASE_INSENSITIVE'i)*
...
table_attribute
  ...
  / ("DISTKEY"i) __ LPAREN __ column_ref __ RPAREN
  / ("COMPOUND"i / "INTERLEAVED"i ) __ "SORTKEY"i __ ( LPAREN __ column_ref_list __ RPAREN /  "AUTO"i )
  / "ENCODE"i __ "AUTO"i
...
KW_BACKUP		  = "BACKUP"i	 !ident_start
...
numeric_type
  = t:(KW_NUMERIC / KW_DECIMAL / KW_INT / KW_INTEGER / KW_SMALLINT / KW_TINYINT / KW_BIGINT / KW_FLOAT / KW_REAL / KW_DOUBLE / KW_DOUBLE_PRECISION) __ LPAREN __ l:[0-9]+ __ r:(COMMA __ [0-9]+)? __ RPAREN __ s:numeric_type_suffix? { /* =>  data_type */ return { dataType: t, length: parseInt(l.join(''), 10), scale: r && parseInt(r[2].join(''), 10), parentheses: true, suffix: s }; }
  / t:(KW_NUMERIC / KW_DECIMAL / KW_INT / KW_INTEGER / KW_SMALLINT / KW_TINYINT / KW_BIGINT / KW_FLOAT / KW_REAL / KW_DOUBLE / KW_DOUBLE_PRECISION)l:[0-9]+ __ s:numeric_type_suffix? { /* =>  data_type */ return { dataType: t, length: parseInt(l.join(''), 10), suffix: s }; }
  / t:(KW_NUMERIC / KW_DECIMAL / KW_INT / KW_INTEGER / KW_SMALLINT / KW_TINYINT / KW_BIGINT / KW_FLOAT / KW_REAL / KW_DOUBLE / KW_DOUBLE_PRECISION) __ s:numeric_type_suffix? __{ /* =>  data_type */ return { dataType: t, suffix: s }; }
